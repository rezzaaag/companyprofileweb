    ...
    <div class="container" style="margin-top: 150px;">
        <div class="row mb-5">
            ...
            <div class="col-lg-5 d-none d-lg-block">
                <img src="assets/vector-productmanager.svg" width="80%">
            </div>

            <div class="col-lg-7">
                <div class="row" style="margin-top: 50px;">
                    <h1 class="bold-3">Our Product</h1>
                    <div class="d-flex desc" style="margin-top: 10px;">
                        <img src="assets/vector-check.svg" width="35px" class="me-3">
                        <h5 class="mt-3">DOOR HRMIS</h5>
                    </div>
                    <div class="d-flex desc" style="margin-top: 10px;">
                        <img src="assets/vector-check.svg" width="35px" class="me-3">
                        <h5 class="mt-3">MATRIS</h5>
                    </div>
                    <div class="d-flex desc" style="margin-top: 10px;">
                        <img src="assets/vector-check.svg" width="35px" class="me-3">
                        <h5 class="mt-3">SUSTERS</h5>
                    </div>
                    <div class="d-flex desc" style="margin-top: 10px;">
                        <img src="assets/vector-check.svg" width="35px" class="me-3">
                        <h5 class="mt-3">SMS MERDEKA</h5>
                    </div>
                </div>
            </div>
        </div>
